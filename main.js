...
var $author$project$ValueList$get = F2(
	function (key, list) {
		return A2(
			$elm$core$Maybe$map,
...
var $author$project$Main$capitalize = function (word) {
	return A2(
		$elm$core$Maybe$withDefault,
		word,
		A2(
			...
			function (_v0) {
				var h = _v0.a;
				var t = _v0.b;
				return A2($elm$core$String$cons, h, t);
			},
			A2(
				$elm$core$Maybe$map,
				$elm$core$Tuple$mapFirst($elm$core$Char$toUpper),
...
var $author$project$Main$message = function (model) {
	...
	if (_v0.$ === 'Nothing') {
		...
		if (_v0.a) {
			...
			return model.previousActual + (' -> Oups. ' + ($author$project$Main$capitalize(model.previousWord) + (' se dit ' + model.previousExpected)));
		}
	}
};
